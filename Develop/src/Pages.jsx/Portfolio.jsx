    ...
    return (
      <div>
        ...
        <div className='projectOne'>
          ...
          <a className='project-link' href="LINK TO PROJECT"> Opti-Tracker</a>
        </div>
        <div className='projectTwo'>
          ...
          <a className='project-link' href="LINK TO PROJECT"> SpeedyREADME</a>
        </div>
        <div className='projectThree'>
          ...
          <a className='project-link' href="LINK TO PROJECT"> Command Line Cars</a>
        </div>
      </div>
      );
    }